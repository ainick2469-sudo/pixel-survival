...
- `0.008`: move to fullscreen-first startup, stabilize buffered chunk streaming/unloading, add greedy chunk meshing, add palette-compressed chunk storage plus runtime telemetry, and add a stronger terrain art pass that can hold up at higher render distances.
